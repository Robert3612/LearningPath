...
```php
//...
use srag\RemovePluginDataConfirm\LearningPath\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\LearningPath\x\RepositoryObjectPluginUninstallTrait;
//...
