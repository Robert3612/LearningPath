...
/**
 * Personal Desktop-Presentation for the LearningPath
 */
class ilDashboardLearningPathGUI
{
    /**
     * @var ilLanguage
     */
    ...
    public function getHTML() : string
    {
        ...
        foreach ($this->getAssignments() as $assignment) {
            ...
            $lso_obj = ilObjLearningPath::getInstanceByRefId($lso_ref_id);
    ...
    protected function getLsoItem(ilObjLearningPath $lso_obj) : ILIAS\UI\Implementation\Component\Item\Standard
    {
    ...
    protected function isRelevantLso(ilObjLearningPath $obj) : bool
    {
        $relevant = false;
    ...
    {
        $status = ilObjLearningPathAccess::isOffline($ref_id);
