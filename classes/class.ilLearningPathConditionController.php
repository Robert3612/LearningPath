...
/**
 * Handle Conditions within the LearningPath Objects.
 *
 * @author Nils Haagen <nils.haagen@concepts-and-training.de>
 */
class ilLearningPathConditionController implements ilConditionControllerInterface
{
    /**
     * @inheritdoc
     */
    ...
    protected function getContainerObject(int $container_ref_id) : ilObjLearningPath
    {
