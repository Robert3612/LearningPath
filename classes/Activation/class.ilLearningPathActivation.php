 ...
 */
class ilLearningPathActivation
{
    /**
     * @var int
     */
    ...
    public function withIsOnline(bool $online) : ilLearningPathActivation
    {
        $clone = clone $this;
        $clone->online = $online;
        return $clone;
    ...
    public function withActivationStart(\DateTime $activation_start = null) : ilLearningPathActivation
    {
        $clone = clone $this;
    ...
    public function withActivationEnd(\DateTime $activation_end = null) : ilLearningPathActivation
    {
        $clone = clone $this;
