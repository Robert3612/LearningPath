 ...
 */
class ilLearningPathActivationDB
{
    ...
    public function getActivationForRefId(int $ref_id) : ilLearningPathActivation
    {
    ...
    public function store(ilLearningPathActivation $settings)
    {
        $where = array(
    ...
    protected function insert(ilLearningPathActivation $settings)
    {
        $start = $settings->getActivationStart();
        $end = $settings->getActivationEnd();
        if ($start) {
    ...
    ) : ilLearningPathActivation {
        return new ilLearningPathActivation(
            $ref_id,
            $online,
            $effective_online,
            $activation_start,
