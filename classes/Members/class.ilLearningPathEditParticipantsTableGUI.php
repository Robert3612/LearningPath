 ...
 */
class ilLearningPathEditParticipantsTableGUI extends ilTable2GUI
{
    /**
     * @var ilLearningPathMembershipGUI
     */
    ...
    public function __construct(
        ilLearningPathMembershipGUI $parent_gui,
        ilObjLearningPath $ls_object,
        ilLearningPathParticipants $ls_participants,
        ...
        $this->setRowTemplate("tpl.edit_participants_row.html", "Modules/LearningPath");
        ...
        if ($this->privacy_settings->enabledLearningPathAccessTimes()) {
    ...
    public function fillRow($set)
    {
        ...
        foreach ($this->ls_object->getLocalLearningPathRoles(true) as $name => $role_id) {
