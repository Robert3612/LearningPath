 ...
 *
 * @ilCtrl_Calls ilLearningPathMembershipGUI: ilMailMemberSearchGUI, ilUsersGalleryGUI, ilRepositorySearchGUI
 * @ilCtrl_Calls ilLearningPathMembershipGUI: ilCourseParticipantsGroupsGUI, ilObjectCustomuserFieldsGUI
 * @ilCtrl_Calls ilLearningPathMembershipGUI: ilSessionOverviewGUI
 * @ilCtrl_Calls ilLearningPathMembershipGUI: ilMemberExportGUI
 *
 */
class ilLearningPathMembershipGUI extends ilMembershipGUI
{
            ...
            switch ($type) {
                case $object->getDefaultAdminRole():
                    ...
                    $members->sendNotification(
                        ilLearningPathMembershipMailNotification::TYPE_ADMISSION_MEMBER,
                        $new_member
                    );
                    $assigned = true;
                    break;
                case $object->getDefaultMemberRole():
                    ...
                    break;
                default:
                    if (in_array($type, $object->getLocalLearningPathRoles(true))) {
                        $members->add($new_member, IL_LSO_MEMBER);
    ...
    protected function initParticipantTableGUI() : ilLearningPathParticipantsTableGUI
    {
        return new ilLearningPathParticipantsTableGUI(
            $this,
    ...
    protected function initEditParticipantTableGUI(array $participants) : ilLearningPathEditParticipantsTableGUI
    {
        $table = new ilLearningPathEditParticipantsTableGUI(
            $this,
            $this->getParentObject(),
    ...
    {
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.lso_edit_members.html', 'Modules/LearningPath');
    }

    public function getLocalTypeRole($a_translation = false)
    {
        return $this->getParentObject()->getLocalLearningPathRoles($a_translation);
    }
    ...
    protected function initWaitingList() : ilLearningPathWaitingList
    {
        return new ilLearningPathWaitingList($this->getParentObject()->getId());
    }
    ...
    /**
     * @return \ilMailMemberLearningPathRoles
     */
    protected function getMailMemberRoles()
    {
        return new ilMailMemberLearningPathRoles();
    }
