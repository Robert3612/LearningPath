 ...
 */
class ilLearningPathXMLWriter extends ilXmlWriter
{
    ...
    {
        $this->xmlSetDtdDef(
            "<!DOCTYPE learning sequence PUBLIC \"-//ILIAS//DTD LearningPath//EN\" \"" .
            ILIAS_HTTP_PATH . "/xml/ilias_lso_5_4.dtd\">"
        );

        $this->xmlSetGenCmt(
            "Export of ILIAS LearningPath " .
    ...
    protected function writeLearningPath()
    {
