...
class ilObjLearningPath extends ilObjectPlugin
{
    ...
    public function doDelete() : bool
    {
        ...
        ilLearningPathParticipants::_deleteAllEntries($this->getId());
     ...
     */
    protected function doCloneObject($target_id, $copy_id = 0, $omit_tree = false)
    {
    ...
    protected function cloneAutoGeneratedRoles(ilObjLearningPath $new_obj) : bool
    {
    ...
    protected function cloneSettings(ilObjLearningPath $new_obj)
    {
    ...
    protected function getSettingsDB() : ilLearningPathSettingsDB
    {
        if (!$this->settings_db) {
    ...
    protected function getActivationDB() : ilLearningPathActivationDB
    {
    ...
    public function getLSActivation() : ilLearningPathActivation
    {
    ...
    public function updateActivation(ilLearningPathActivation $settings)
    {
        $this->getActivationDB()->store($settings);
        $this->ls_activation = $settings;
    }

    public function getLSSettings() : ilLearningPathSettings
    {
        if (!$this->ls_settings) {
    ...
    public function updateSettings(ilLearningPathSettings $settings)
    {
    ...
    public function getLSParticipants() : ilLearningPathParticipants
    {
    ...
    public function getLSAccess() : ilObjLearningPathAccess
    {
        if (is_null($this->ls_access)) {
            $this->ls_access = new ilObjLearningPathAccess();
        }
    ...
    public function getLSRoles() : ilLearningPathRoles
    {
        if (!$this->ls_roles) {
    ...
    {
        return $this->getLSRoles()->getLocalLearningPathRoles($translate);
    }
    ...
    public function getLearningPathMemberData($a_mem_ids, $active = 1)
    {
        return $this->getLSRoles()->getLearningPathMemberData($a_mem_ids, $active);
    }

    public function getDefaultLearningPathRoles($a_grp_id = "")
    {
        return $this->getLSRoles()->getDefaultLearningPathRoles($a_grp_id);
    }
