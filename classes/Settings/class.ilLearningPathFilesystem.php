 ...
 */
class ilLearningPathFilesystem extends ilFileSystemStorage
{
    ...
    public function moveUploaded(
        string $which,
        array $file_info,
        ilLearningPathSettings $settings
    ...
    public function delete_image(string $which, ilLearningPathSettings $settings)
    {
        if ($which === self::IMG_ABSTRACT) {
