...
class ilLearningPathSettings
{
    ...
    public function withAbstract(string $abstract) : ilLearningPathSettings
    {
        $clone = clone $this;
    ...
    public function withExtro(string $extro) : ilLearningPathSettings
    {
        $clone = clone $this;
        $clone->extro = $extro;
        return $clone;
    ...
    public function withAbstractImage(string $path = null) : ilLearningPathSettings
    {
        $clone = clone $this;
    ...
    public function withExtroImage(string $path = null) : ilLearningPathSettings
    {
        $clone = clone $this;
    ...
    public function withUpload(array $upload_info, string $which) : ilLearningPathSettings
    {
        $clone = clone $this;
    ...
    public function withDeletion(string $which) : ilLearningPathSettings
    {
        $clone = clone $this;
    ...
    public function withMembersGallery(bool $members_gallery) : ilLearningPathSettings
    {
        $clone = clone $this;
