...
/**
 * Class ilObjLearningPathContentGUI
 *
...
class ilObjLearningPathContentGUI
{
    ...
    public function __construct(
        ilObjLearningPathGUI $parent_gui,
        ilCtrl $ctrl,
    ...
    public function executeCommand()
    {
        ...
        switch ($cmd) {
            ...
            case self::CMD_CONFIRM_DELETE:
                ...
                break;
            default:
                throw new ilException("ilObjLearningPathContentGUI: Command not supported: $cmd");
        }
    }
    ...
    {
        $table = new ilObjLearningPathContentTableGUI(
            $this,
