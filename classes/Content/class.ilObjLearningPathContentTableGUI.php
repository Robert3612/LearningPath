 ...
 */
class ilObjLearningPathContentTableGUI extends ilTable2GUI
{
    public function __construct(
        ilObjLearningPathContentGUI $parent_gui,
        string $cmd,
        ilCtrl $ctrl,
        ilLanguage $lng,
        ilAccess $access,
        ...
        $this->setRowTemplate("tpl.content_table.html", "Modules/LearningPath");
